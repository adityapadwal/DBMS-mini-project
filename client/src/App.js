      ...
      <div className="faculty_main">
        ...
        <div className="faculty-form">
          <div className="information">
            ...
            />
            <button onClick={addFaculty}><b>Add Faculty</b></button>
          </div>
          <div className="faculties">
            <button onClick={getFaculty}><b>Show Faculty</b></button>
          </div>
      ...
      <div className="student_main">
        ...
        <div className="student-form">
          <div className="information">
            ...
            />
            <button onClick={addStudent}><b>Add Student</b></button>
          </div>
          <div className="faculties">
            <button onClick={getStudent}><b>Show Student</b></button>
          </div>
